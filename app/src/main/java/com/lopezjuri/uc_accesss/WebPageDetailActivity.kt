 ...
 * in a [WebPageListActivity].
 */
class WebPageDetailActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (savedInstanceState == null) {
            ...
            arguments.putString(WebPageDetailFragment.ARG_ITEM_ID,
                    intent.getStringExtra(WebPageDetailFragment.ARG_ITEM_ID))
            val fragment = WebPageDetailFragment()
            fragment.arguments = arguments
            supportFragmentManager.beginTransaction().add(R.id.webpage_detail_container, fragment).commit()
        }
    }
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        ...
        if (id == android.R.id.home) {
            ...
            //
            navigateUpTo(Intent(this, WebPageListActivity::class.java))
            return true
        }
